...
def process_data(file_number):
    ...
    # time_records['custom_bpc'] = time.time() - start_time
    # print("Time of custom_bpc:", time_records['custom_bpc'])
    ...
    # num_runs = 10
    # # 1. K-means 聚类
    # acc_kmeans, nmi_kmeans, ari_kmeans, time_kmeans = kmeans_accuracy(X, y, k, num_runs)
    # print("Time of kmeans:", time_kmeans)
    #
    # # 2. 层次聚类
    ...
    # time_records['hierarchical'] = time.time() - start_time
    # print("Time of hierarchical:", time_records['hierarchical'])  # 无f-string版本
    #
    ...
    #
    # # 3. 谱聚类
    # #acc_spectral, nmi_spectral, ari_spectral, time_spectral = spectral_accuracy(X, y, k, num_runs)
    # acc_spectral, nmi_spectral, ari_spectral, time_spectral = spectral_accuracy(X, y, k, 2)
    # print("Time of spectral:", time_spectral)
    #
    #
    # # 4. 高斯混合模型聚类
    ...
    # start_time = time.time()
    # pred_ap = apgpt(X, k)
    # time_records['ap'] = time.time() - start_time
    # print("Time of ap:", time_records['ap'])  # 无f-string版本
    #
    ...
    #
    # # 6.Density-Peak 聚类（dp聚类）
    # print("Running Density-Peak Clustering...")
    # start_time = time.time()
    # pred_dp = cluster_dp_k(X, k)
    # time_records['dp'] = time.time() - start_time
    # print("Time of dp:", time_records['dp'])
    #
    ...
    #
    # # 7.Fuzzy C-means聚类
    # acc_fcm, nmi_fcm, ari_fcm, time_fcm = fcm_accuracy(X, y, k, num_runs)
    # print("Time of fcm:", time_fcm)

    # 8.Border-Peeling Clustering (BPC)聚类
    ...
    run_time = [#time_records['custom_kmeans'],
                #time_records['custom_hierarchical'],
                #time_records['custom_spectral'],
                #time_records['custom_gmm'],
                time_records['custom_ap'],
                #time_records['custom_dp'],
                #time_records['custom_fcm']
                ]
...
def main():
    #for file_number in range(91, 146):  # 从1到145
    for file_number in [7,8,16,34,37,38,43,63,86,97,98,101,122,144,
                       21, 40, 48, 58, 61, 64, 90, 127, 135, 143,
                        18,57,67,71,94,121,123,139,140,145,
                        39,60,95,128]:
    # for file_number in [39, 60, 95, 128, 135,
    #                     18, 38, 57, 71, 86, 94, 121, 122, 140, 143, 145]:
    # for file_number in[ 127,135,143,
    #                     18,57,67,71,94,121,123,139,140,145,
    #                     39,60,95,128]:
        # 处理每个数据集
